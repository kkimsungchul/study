...
public class NewInsertJenkinsVO {
    ...
    /**
     * 배포 서버 타입코드(10101 - TB, 10102 - PRD)
     */
    @ApiModelProperty(name = "serverTypeCode", value = "배포 서버 타입코드", dataType = "String", example = "10101")
    private String serverTypeCode;

    /**
     * 배포 서버 영역코드(10202 - IPC, 10203 - EPC, 10204 - Container, 10201 - RM)
     */
    @ApiModelProperty(name = "serverZoneCode", value = "배포 서버 영역코드", dataType = "String", example = "10201")
    private String serverZoneCode;
	...
	public String getServerZoneCode() {
		return serverZoneCode;
	}

	public void setServerZoneCode(String serverZoneCode) {
		this.serverZoneCode = serverZoneCode;
	}
	...
	public String toString() {
		return "NewInsertJenkinsVO [serverTypeCode=" + serverTypeCode + ", serverZoneCode=" + serverZoneCode + ", id="
				+ id + ", projectId=" + projectId + ", jenkinsFolderName=" + jenkinsFolderName + ", jenkinsJobName="
				+ jenkinsJobName + ", serviceStatus=" + serviceStatus + ", createdBy=" + createdBy + ", createdDate="
				+ createdDate + ", lastModifiedBy=" + lastModifiedBy + ", lastModifiedDate=" + lastModifiedDate
				+ ", jenkinsJobType=" + jenkinsJobType + ", jenkinsJobTypeName=" + jenkinsJobTypeName + ", division="
