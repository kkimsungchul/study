...
%JAVA_HOME%\bin\javac -Xlint:unchecked -d %DAEMON_HOME%\classes -classpath %CLASSPATH_DIR% %DAEMON_HOME%\src\receiveCustomWorker.java

%JAVA_HOME%\bin\javac -Xlint:unchecked -d %DAEMON_HOME%\classes -classpath %CLASSPATH_DIR% %DAEMON_HOME%\src\sendCustomWorker.java

%JAVA_HOME%\bin\javac -Xlint:unchecked -d %DAEMON_HOME%\classes -classpath %CLASSPATH_DIR% %DAEMON_HOME%\src\testCustomWorker.java
