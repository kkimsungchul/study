...
%JAVA_HOME%\bin\java -DagentName=%DAEMON_NAME% -showversion -Xms128m -Xmx1000m -classpath %CLASSPATH_DIR% com.securus.adaptor.WorkBatch %DAEMON_HOME% receive
