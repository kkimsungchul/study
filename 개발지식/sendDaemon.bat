...
set DAEMON_NAME="sendDaemon"
set DAEMON_HOME="D:\imAgent"

echo ------------------------------------------------------------
echo -- sendDaemon V1.0
...
%JAVA_HOME%\bin\java -DagentName=%DAEMON_NAME% -showversion -Xms128m -Xmx1000m -classpath %CLASSPATH_DIR% com.securus.adaptor.WorkDaemon %DAEMON_HOME% send
